...
export default {
  ...
  methods: {
    ...
    updateAggregatedVis() {
      ...
      this.aggregatedNodes
        .each(d => {
          ...
          if (gridpoint) {
            d.newX = gridpoint.x + shift[0]
            d.newY = gridpoint.y + shift[1]
          }
        })
        .attr('cx', d => d.newX)
        .attr('cy', d => d.newY)
    ...
    initNeighbourData() {
      ...
      this.neighbour.forEach(d => {
        console.log('d', d)
        console.log('d.hood', d.hood)
      })
    ...
    getHull() {
      ...
      pointis = [...sortPoints(this.anchorPoint, this.points, this)] //sortPoints(this.anchorPoint, this.points, this)
